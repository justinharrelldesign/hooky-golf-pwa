...
import svgPaths from "../imports/svg-d385xvmwrq";
import imgDeadlineDan from "figma:asset/639913f4590217518f4a29a4f9cc4bfc94bde609.png";
...
interface DeadlineDanBossProps {
  hole: number;
  onContinue: () => void;
  onExitRound: () => void;
}

export function DeadlineDanBoss({ hole, onContinue, onExitRound }: DeadlineDanBossProps) {
  ...
  return (
    <div className="bg-[#cee7bd] relative size-full min-h-screen flex flex-col items-center py-[24px]" data-name="iPhone 16 Plus - 6">
      <div className="box-border content-stretch flex flex-col gap-[8px] items-center justify-center px-[16px] py-[24px] rounded-[32px] w-[382px] relative">
        ...
        <div className="h-[308px] relative shrink-0 w-[236px]" data-name="ChatGPT Image Sep 26, 2025 at 10_11_39 AM 1">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="Deadline Dan illustration" className="absolute h-full w-full object-contain object-center max-w-none" src={imgDeadlineDan} />
          </div>
        </div>
        <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
          ...
          <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">"I may not always make it to the toilet on time, but I sure as shit expect you meet your deadline on time!"</p>
        </div>
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
          <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
            ...
            <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
              No time to waste. Secure a 1 putt to get Dan off your case.
            </p>
          </div>
          <button 
            onClick={onContinue}
