...
import svgPaths from "../imports/svg-176jvq9e9s";
import imgCubicalChuck from "figma:asset/88d4ac832cde727bb6ce70e63518f7d9460b6fae.png";
...
interface CubicalChuckBossProps {
  hole: number;
  onContinue: () => void;
  onExitRound: () => void;
}

export function CubicalChuckBoss({ hole, onContinue, onExitRound }: CubicalChuckBossProps) {
  ...
  return (
    <div className="bg-[#cee7bd] relative size-full min-h-screen flex flex-col items-center py-[24px]" data-name="iPhone 16 Plus - 7">
      <div className="box-border content-stretch flex flex-col gap-[8px] items-center justify-center px-[16px] py-[24px] rounded-[32px] w-[382px] relative">
        ...
        <div className="h-[308px] relative shrink-0 w-[236px]" data-name="Cubical Chuck">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="Cubical Chuck illustration" className="absolute h-full w-full object-contain object-center max-w-none" src={imgCubicalChuck} />
          </div>
        </div>
        ...
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
          <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
            ...
            <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
              Find a golf ball to avoid Chuck from snitching out of jealousy.
            </p>
          </div>
          <button 
            onClick={onContinue}
