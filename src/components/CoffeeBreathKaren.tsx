...
import svgPaths from "../imports/svg-9zbnfduvo5";
import imgCoffeeBreathKaren from "figma:asset/0cb85757b9ceba4d82522da1b60933c8a40fb2e5.png";
...
interface CoffeeBreathKarenProps {
  hole: number;
  onContinue: () => void;
  onExitRound: () => void;
}

export function CoffeeBreathKaren({ hole, onContinue, onExitRound }: CoffeeBreathKarenProps) {
  ...
  return (
    <div className="bg-[#cee7bd] relative size-full min-h-screen flex flex-col items-center py-[24px]" data-name="iPhone 16 Plus - 8">
      <div className="box-border content-stretch flex flex-col gap-[8px] items-center justify-center px-[16px] py-[24px] rounded-[32px] w-[382px] relative">
        ...
        <div className="content-stretch flex flex-col items-start relative shrink-0">
          <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-[231px]">Coffee Breath Karen</p>
        </div>
        <div className="content-stretch flex gap-[10px] h-[308px] items-center justify-center relative shrink-0">
          <div className="h-full relative shrink-0 w-full flex items-center justify-center" data-name="Coffee Breath Karen">
            <div className="relative h-full w-full max-w-[220px] flex items-center justify-center">
              <img alt="Coffee Breath Karen illustration" className="max-h-full max-w-full object-contain" src={imgCoffeeBreathKaren} />
            </div>
          </div>
        </div>
        <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
          ...
          <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">"That smell? It isn't the goose shit you stepped in last hole. That's my roasted bean breath catching you red handed!"</p>
        </div>
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
          <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
            ...
            <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
              Avoid any hazards and Karen's hot breath.
            </p>
          </div>
          <button 
            onClick={onContinue}
