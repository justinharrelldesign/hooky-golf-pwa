import svgPaths from "./svg-btt80o07w1";
import imgChatGptImageSep262025At040129Pm1 from "figma:asset/57fce1270342241e056c8e48e2ed078e3b7e0dcb.png";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">Bike commute brandon</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“I’ll pedal your ass back to the office faster than I blow out the back of my spandex.”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Show Brandon some speed his bike could never match. Hit a drive 250+ yards.
      </p>
    </div>
  );
}
...
export default function IPhone16Plus29() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 29">
      <Frame16 />
    </div>
  );
}