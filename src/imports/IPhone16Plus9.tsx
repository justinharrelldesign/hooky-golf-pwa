import svgPaths from "./svg-kxhkxh4yxr";
import imgChatGptImageSep262025At040129Pm1 from "figma:asset/1fcb81e0333b665ae0aaa78b9b7c3d22c9fb1e0f.png";
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“You think my gum smacking is loud? Wait until you here me yell to the whole office that you’re sneaking out!”</p>
    </div>
  );
}
...
export default function IPhone16Plus9() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 9">
      <Frame16 />
    </div>
  );
}