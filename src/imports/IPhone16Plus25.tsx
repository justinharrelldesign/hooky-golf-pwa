import svgPaths from "./svg-0rytcfbtj9";
import imgChatGptImageSep262025At040129Pm1 from "figma:asset/55a85bdb18ad4a0e93c38214a87911c2e2e7b019.png";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">Awful Office couple</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“We don’t jussst share shhhhexy shmoochesss… we’ll alssso gladly share your little golf outing with the entire offissse.”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Time to cock-block Cupid. Only a birdie or better gets you past this nightmare.
      </p>
    </div>
  );
}
...
export default function IPhone16Plus25() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 25">
      <Frame16 />
    </div>
  );
}