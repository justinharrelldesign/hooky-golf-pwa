import svgPaths from "./svg-8wjs5kmmfr";
...
function Frame32() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] items-start pb-[16px] pt-0 px-0 relative shrink-0">
...
function Frame52() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-0 top-0">
      <Frame49 />
      <Frame32 />
      <Frame50 />
    </div>
...
function Frame27() {
  return (
    <div className="absolute bg-[#517b34] box-border content-stretch flex gap-[10px] h-[48px] items-center justify-center left-0 overflow-clip px-[39px] py-[12px] rounded-[100px] top-[270px] w-[350px]">
...
function Frame51() {
  return (
    <div className="h-[318px] relative shrink-0 w-[350px]">
      <Frame52 />
      <Frame27 />
    </div>
  );
...
export default function IPhone16Plus17() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 17">
      <Frame16 />
    </div>
  );
}