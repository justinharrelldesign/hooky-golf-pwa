import svgPaths from "./svg-p1li0h24du";
import imgChatGptImageSep262025At040129Pm1 from "figma:asset/c61d4559e666544ed0c6c7e6a5621b444167be71.png";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">Office security Sean</p>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[308px] items-end justify-center left-[8px] top-[3px]">
...
function OfficeSecurityShawn() {
  return (
    <div className="bg-[#cee7bd] h-[308px] overflow-clip relative shrink-0 w-[226px]" data-name="Office Security Shawn">
      <Frame19 />
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“You golf, I report. That’s the chain of command, chief.”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Sean runs the lost and found like Fort Knox. Lose a ball and he’ll shake you down like a vending machine that ate his dollar.
      </p>
    </div>
  );
}
...
export default function IPhone16Plus35() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 35">
      <Frame16 />
    </div>
  );
}