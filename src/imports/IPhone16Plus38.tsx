import svgPaths from "./svg-wir8uajm7w";
import imgChatGptImageSep252025At111411Am1 from "figma:asset/27c868d43be0c66c09861397c5b9926a235b4245.png";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">Geriatric Gertrude</p>
    </div>
  );
}

function GeriatricGertrude() {
  return (
    <div className="bg-[#cee7bd] h-[308px] overflow-clip relative shrink-0 w-[226px]" data-name="Geriatric Gertrude">
      <div className="absolute h-[294px] left-[21px] top-[10px] w-[186px]" data-name="ChatGPT Image Sep 25, 2025 at 11_14_11 AM 1">
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“Don’t mind the smell, dear. that’s just me decomposing like your job security.”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Gertrude doesn’t have much longer. Go long of the green and her last words will be turning you in.
      </p>
    </div>
  );
}
...
export default function IPhone16Plus38() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 38">
      <Frame16 />
    </div>
  );
}