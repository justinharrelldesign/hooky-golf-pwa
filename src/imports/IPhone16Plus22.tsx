import svgPaths from "./svg-4xtidjx1vv";
import imgChatGptImageSep262025At040129Pm1 from "figma:asset/45624890830498d823325b0b6e621888011b2f3a.png";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">Sweaty Stan</p>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="h-[308px] relative shrink-0 w-[226px]">
      <ItNerdNed />
      <div className="absolute bg-[#cee7bd] h-[32px] left-[179px] top-[191px] w-[29px]" />
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“The only puddles bigger than mine are from the tears you’ll cry getting sent back to work.”</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>{`Time for you to work up a sweat. Finish the hole in less than 10 minutes. `}</p>
    </div>
  );
}
...
export default function IPhone16Plus22() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 22">
      <Frame16 />
    </div>
  );
}