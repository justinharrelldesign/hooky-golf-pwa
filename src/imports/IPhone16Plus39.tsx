import svgPaths from "./svg-8w7fjqpy5m";
import imgChatGptImageSep252025At111411Am1 from "figma:asset/4441c4e4832246c4ddf8c3e39f4101fb3eedb41f.png";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">Rancid lunch rick</p>
    </div>
  );
}

function MicrowaveMike() {
  return (
    <div className="bg-[#cee7bd] h-[308px] overflow-clip relative shrink-0 w-[226px]" data-name="Microwave Mike">
      <div className="absolute h-[288px] left-[22px] top-[17px] w-[181px]" data-name="ChatGPT Image Sep 25, 2025 at 11_14_11 AM 1">
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“My lunch may smell of death but so does your career.”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        No microwave for Rick and no mark for you. 2 putt without marking your ball or Rick is making a mess of your round.
      </p>
    </div>
  );
}
...
export default function IPhone16Plus39() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 39">
      <Frame16 />
    </div>
  );
}