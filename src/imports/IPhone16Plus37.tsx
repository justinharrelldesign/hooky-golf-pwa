import svgPaths from "./svg-pwpxltb5w6";
import imgChatGptImageSep262025At102526Am1 from "figma:asset/993ba9f3de295471da367c5a64c21aa9e9f3c424.png";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">Patient zero paulie</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“just Like my snot filled nose, you can run but you can’t hide!”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Paulie used your tees to plug his nose. Make par or better this hole without using them.
      </p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[8px] items-center justify-center left-[24px] px-[16px] py-[24px] rounded-[32px] top-[24px] w-[382px]">
      ...
      <Frame17 />
      <div className="h-[309px] relative shrink-0 w-[219px]" data-name="ChatGPT Image Sep 26, 2025 at 10_25_26 AM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[106.71%] left-0 max-w-none top-[-3.36%] w-[100.05%]" src={imgChatGptImageSep262025At102526Am1} />
        </div>
      </div>
      <Frame18 />
      <Frame29 />
...
export default function IPhone16Plus37() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 37">
      <Frame16 />
    </div>
  );
}