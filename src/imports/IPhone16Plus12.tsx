import svgPaths from "./svg-s6ueg7bj6y";
import imgChatGptImageSep262025At040129Pm1 from "figma:asset/32ed6a512f56ded517a43e00b4c143ef9d80f042.png";
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“I’ll rob you of your day of golf just like I robbed you of your lunch you packed. Finders keepers...”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Don’t chunk a shot or Barb will waddle straight to your bosses office and turn you in.
      </p>
    </div>
  );
}
...
export default function IPhone16Plus12() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 12">
      <Frame16 />
    </div>
  );
}