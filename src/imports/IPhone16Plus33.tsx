import svgPaths from "./svg-egnqk5x80q";
import imgChatGptImageSep252025At111411Am1 from "figma:asset/60147dfc7c60d948dac7c186a77a65b1fea0f418.png";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">Brown Noser Ben</p>
    </div>
  );
}

function BrownNoserBen() {
  return (
    <div className="bg-[#cee7bd] h-[308px] overflow-clip relative shrink-0 w-[226px]" data-name="Brown Noser Ben">
      <div className="absolute h-[288px] left-[22px] top-[14px] w-[181px]" data-name="ChatGPT Image Sep 25, 2025 at 11_14_11 AM 1">
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“Something stinks of slacking off...”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Keep your ball and reputation clean. Any mud balls, and you’re in deeper shit than Ben’s nose.
      </p>
    </div>
  );
}
...
export default function IPhone16Plus33() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 33">
      <Frame16 />
    </div>
  );
}