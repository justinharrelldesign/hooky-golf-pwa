import svgPaths from "./svg-86d5tw7ljs";
import imgChatGptImageSep252025At111411Am1 from "figma:asset/62970970e1e5c66f84ac0363c803b312f56cc9a7.png";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">Keyboard clicker kate</p>
    </div>
  );
}

function PartyPlannerPenny() {
  return (
    <div className="bg-[#cee7bd] h-[308px] overflow-clip relative shrink-0 w-[226px]" data-name="Party Planner Penny">
      <div className="absolute h-[288px] left-[23px] top-[10px] w-[181px]" data-name="ChatGPT Image Sep 25, 2025 at 11_14_11 AM 1">
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“Click-click-click. the only thing louder than my typing is my pie hole reporting you.”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Miss a tap-in and Kate is drafting an email with her turd filled nails.
      </p>
    </div>
  );
}
...
export default function IPhone16Plus36() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 36">
      <Frame16 />
    </div>
  );
}