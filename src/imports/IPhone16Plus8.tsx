import svgPaths from "./svg-9zbnfduvo5";
import imgChatGptImageSep262025At010458Pm1 from "figma:asset/28c816a10dafe088bd5e31fca5ae6f18e8e19baa.png";
...
function Frame19() {
  return (
    <div className="bg-white content-stretch flex gap-[10px] h-[308px] items-end justify-center mix-blend-color-burn relative shrink-0">
      <div className="h-[314px] relative shrink-0 w-[226px]" data-name="ChatGPT Image Sep 26, 2025 at 01_04_58 PM 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[136.64%] left-[-18.35%] max-w-none top-[-15.58%] w-[126.27%]" src={imgChatGptImageSep262025At010458Pm1} />
        </div>
      </div>
    </div>
  );
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“The only thing that stinks worse than my breath is your work ethic!”</p>
    </div>
  );
}
...
export default function IPhone16Plus8() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 8">
      <Frame16 />
    </div>
  );
}