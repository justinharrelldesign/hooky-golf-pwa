import svgPaths from "./svg-7at7zhgs51";
import imgChatGptImageSep262025At040129Pm1 from "figma:asset/03c5e6045e8a670db62484e7b57bb581a73f475a.png";
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“I was about to Reply-All to the potluck invite that I would bring my famous egg salad… but instead, I’ll let everyone know about your little golf outing!”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Play as clueless as Rebecca. Make one putt with your eyes closed and make bogey or better.
      </p>
    </div>
  );
}
...
export default function IPhone16Plus10() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 10">
      <Frame16 />
    </div>
  );
}