import svgPaths from "./svg-gfr3t34g1w";
import imgChatGptImageSep262025At040129Pm1 from "figma:asset/6ff250dd884dc88930187b8d43b6369547160f88.png";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">IT LORd Leonard</p>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[308px] items-end justify-center left-[10px] top-0">
      <div className="h-[308px] relative shrink-0 w-[205.333px]" data-name="ChatGPT Image Sep 26, 2025 at 04_01_29 PM 1">
...
function ItNerdNed() {
  return (
    <div className="bg-[#cee7bd] h-[308px] overflow-clip relative shrink-0 w-[226px]" data-name="IT Nerd Ned">
      <Frame19 />
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-[16px] pt-0 px-0 relative shrink-0 w-full">
      ...
      <p className="font-['Luckiest_Guy:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[#282828] text-[20px] text-center w-full">“Your drives may slice, but your data’s straight to my inbox.”</p>
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic pb-0 pt-[16px] px-0 relative shrink-0 text-[#282828] text-center">
      ...
      <p className="font-['Geologica:Regular',_sans-serif] font-normal relative shrink-0 text-[18px] w-[350px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Your drive has to be straighter than the train tracks on Leonards’s braces.
      </p>
    </div>
  );
}
...
export default function IPhone16Plus21() {
  return (
    <div className="bg-[#cee7bd] relative size-full" data-name="iPhone 16 Plus - 21">
      <Frame16 />
    </div>
  );
}