...
const bosses: Boss[] = [
  ...
  {
    name: "HR Helen",
    challenge: "Avoid the water hazard",
    quote: "I've been reviewing our attendance policies. Your lunch break ended 3 minutes ago...",
    avatar: "📄",
    backgroundColor: "bg-indigo-400"
  },
  {
    name: "Tech Tony",
    challenge: "Make birdie",
    quote: "Your computer shows zero productivity for the last 10 minutes. Running a diagnostic now...",
    avatar: "💻",
    backgroundColor: "bg-cyan-400"
  },
  {
    name: "Office Manager Olga",
    challenge: "2-putt or better",
    quote: "I organize everything in this office. And right now, you should be organizing your desk!",
    avatar: "📌",
    backgroundColor: "bg-rose-400"
  },
  {
    name: "Sales Sam",
    challenge: "Drive 250+ yards",
    quote: "I've got this amazing deal on productivity software. Perfect for people who... wander off...",
    avatar: "📈",
    backgroundColor: "bg-emerald-400"
  },
  {
    name: "Legal Linda",
    challenge: "Stay in the fairway",
    quote: "According to subsection 12.4 of your employment contract, unauthorized departures may constitute...",
    avatar: "⚖️",
    backgroundColor: "bg-slate-400"
  },
  {
    name: "Intern Ian",
    challenge: "Make par or better",
    quote: "Wow, going somewhere cool? I wish I could leave too! Maybe I should tell someone...",
    avatar: "🎓",
    backgroundColor: "bg-lime-400"
  },
  {
    name: "Quality Assurance Quinn",
    challenge: "Hit within 50 yards",
    quote: "I've been monitoring workplace efficiency metrics. Your current trajectory is... concerning.",
    avatar: "🔬",
    backgroundColor: "bg-teal-400"
  },
  {
    name: "Facilities Frank",
    challenge: "Avoid all hazards",
    quote: "I know every corner of this building. And that exit you're heading to? I just locked it.",
    avatar: "🔧",
    backgroundColor: "bg-orange-400"
  },
  {
    name: "Training Tina",
    challenge: "Make eagle",
    quote: "Perhaps we need to schedule some additional time management training sessions...",
    avatar: "📚",
    backgroundColor: "bg-violet-400"
  },
  {
    name: "Security Chief Stan",
    challenge: "Perfect shot - hole in one",
    quote: "Badge scans show you've been moving suspiciously. Time for some enhanced monitoring.",
    avatar: "🛡️",
    backgroundColor: "bg-gray-400"
  },
  {
    name: "CEO Catherine",
    challenge: "Ultimate challenge - eagle or better",
    quote: "I built this company from the ground up. Did you really think you could sneak past ME?",
    avatar: "👑",
